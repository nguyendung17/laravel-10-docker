                ...
                <div class="col-xl-5 col-xxl-4">
                    <div class="authentication-login min-vh-100 bg-body row justify-content-center align-items-center p-4">
                        <div class="col-sm-8 col-md-6 col-xl-9">
                            ...
                            <p class=" mb-9">Register Account</p>
                            ...
                            <form action="{{route('auth.signup')}}" method="POST">
                                ...
                                <div class="mb-4">
                                    <label for="exampleInputPassword12" class="form-label">Password Confirm</label>
                                    <input name="password_confirmation" type="password" class="form-control" id="exampleInputPassword12">
                                </div>
                                ...
                                <div class="d-flex align-items-center justify-content-center">
                                    <a class="text-primary fw-medium ms-2" href="/login">Back</a>
                                </div>
